...
function isFFunction(item) {
    return exports.reflection.isInstance(item, exports.FFunction);
}
exports.isFFunction = isFFunction;
...
function isDDate(item) {
    return exports.reflection.isInstance(item, exports.DDate);
}
exports.isDDate = isDDate;
exports.Month = 'Month';
